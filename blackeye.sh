...
# Coded by: @mantukumar (https://github.com/thelinuxchoice/blackeye) Give me the credits if copy ANY part from this code. Don't be NOOB!!
# Upgraded by: @Ms_Cool (https://github.com/whiteeagle0/blackeye)
# Credits (Copyright)
